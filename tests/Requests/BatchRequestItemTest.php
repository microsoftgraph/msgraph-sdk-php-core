...
class BatchRequestItemTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->requestInformation->headers = ["test" => "value"];
        $this->requestInformation->setUri(new Uri('https://graph.microsoft.com/v1/users?$top=2'));

        $this->psrRequest = new Request(HttpMethod::POST, "https://graph.microsoft.com/v1/users", [], Utils::streamFor(json_encode(["key" => "val"])));
    }
    ...
    public function testConstructor()
    {
        ...
        $this->assertEquals($this->requestInformation->headers, $batchRequestItem->getHeaders());
    ...
    public function testCreateWithPsrRequest()
    {
        ...
        $this->assertEquals(['host' => 'graph.microsoft.com'], $batchRequestItem->getHeaders());
